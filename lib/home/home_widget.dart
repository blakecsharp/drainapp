              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (homeUsersRecord.agreedToTerms ?? true)
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 0.0, 20.0, 20.0),
                    ...
                    if (!valueOrDefault<bool>(
                        currentUserDocument?.agreedToTerms, false))
                      AuthUserStreamWidget(
                        builder: (context) => Text(
                          'First time? Click below to get started.',
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                      ),
                    if (!homeUsersRecord.agreedToTerms!)
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 0.0, 20.0, 20.0),
                        child: FFButtonWidget(
                          ...
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Confirm'),
                                    content: Text(
                                        'Are you sure you want to erase all your data and start over?'),
                                    actions: [
                                      TextButton(
